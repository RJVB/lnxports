...
if {![file exists ${gnu_info.install_info}]} {
    # this means port:texinfo was installed with +fromHost; drop the absolute path approach.
    default gnu_info.install_info {install-info}
}
